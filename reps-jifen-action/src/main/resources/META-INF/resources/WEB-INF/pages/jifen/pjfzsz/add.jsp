...
<html>
  ...
  <body>
    <reps:container layout="true">
  	<reps:panel id="myform" dock="none" border="true" action="save.mvc" formId="xform" validForm="true" method="post" title="新增评价指标">
		<input type="hidden" name="category" value="${category}">
		<reps:formcontent style="margin-top:30px">
           <reps:formfield label="指标项 " fullRow="true">
				<reps:input id="item" name="item" maxLength="30" required="true"></reps:input>
           </reps:formfield>
            <reps:formfield label="指标类型" fullRow="true" >
           		<reps:select name="mark" jsonData="{1:'奖励',0:'惩罚'}" headerValue="" style="width:176px;" required="true"></reps:select>
		   </reps:formfield>
		   <reps:formfield label="奖励/扣除积分" fullRow="true" >
           		<reps:select name="pointsScope" jsonData="{'1':'0~1','2':'0~2','3':'0~3','4':'0~4','5':'0~5','-1':'-1~0','-2':'-2~0','-3':'-3~0','-4':'-4~0','-5':'-5~0'}" headerValue="" style="width:176px;" required="true"></reps:select>
		   </reps:formfield>
           ...
           <reps:formfield label="是否可用" fullRow="true" >
           		<reps:select name="isEnable" jsonData="{1:'是',0:'否'}" headerValue="" style="width:176px;" required="true"></reps:select>
		   </reps:formfield>
