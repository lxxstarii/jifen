	...
	<reps:panel id="first" dock="top" action="add.mvc" formId="form" validForm="true" style="width:800px">
		<reps:formcontent>
			...
			<reps:formfield label="兑换截至时间" labelStyle="width:20%;" textStyle="width:20%;">
				<reps:datepicker name="finishTimeDisp" format="yyyy-MM-dd" required="true"></reps:datepicker>
		    </reps:formfield>
			...
			<reps:formfield label="上线时间" labelStyle="width:20%;" textStyle="width:20%;" fullRow="true">
				<reps:datepicker name="showTimeDisp" format="yyyy-MM-dd" required="true"></reps:datepicker>
		    </reps:formfield>
		    
			<reps:formfield label="活动详情" fullRow="true">
				<reps:input name="description" maxLength="200" multiLine="true" style="width:515px;height:70px"></reps:input>
			</reps:formfield>
